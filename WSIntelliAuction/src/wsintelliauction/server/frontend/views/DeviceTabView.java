...
public class DeviceTabView extends JPanel {
	...
	public DeviceTabView() {
		...
		JCheckBox chckbxSimulateCognitiveDevice = new JCheckBox("Simulate device");
		...
		simParamPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Simulator Parameters", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		driverSettingsPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Driver Configuration", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		driverPanel.add(driverSettingsPanel, "cell 0 1,grow");
		driverSettingsPanel.setLayout(new MigLayout("", "[138.00][170.00][grow]", "[]"));
		
		JLabel lblSelectDevice = new JLabel("Select device:");
		driverSettingsPanel.add(lblSelectDevice, "cell 0 0,alignx left");
		
		JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"[no devices registered]"}));

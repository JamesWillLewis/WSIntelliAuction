...
public class ServerTab extends JPanel {
	...
	public ServerTab() {
		setBorder(new TitledBorder(null, "Server Management",
	...
	private void init() {
		...
		serverSettingsTab.add(btnNewButton, "cell 0 6,aligny bottom");
		
		JButton btnNewButton_1 = new JButton("Shutdown");
		btnNewButton_1.setHorizontalAlignment(SwingConstants.LEFT);
		serverSettingsTab.add(btnNewButton_1, "cell 1 6,aligny bottom");
		...
		serverSettingsTab.add(chckbxAcceptConnections_1, "cell 2 6,alignx right");
		...
		JTextArea txtrInitializingServer = new JTextArea();
		txtrInitializingServer.setText("> Initializing server...\r\n> Establishing connection...\r\n> Creating host...\r\n> Opening socket...\r\n> Server active.\r\n> Client connected...\r\n> ETC....");
		consolePane.setViewportView(txtrInitializingServer);
	}

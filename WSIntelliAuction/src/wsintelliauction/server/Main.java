...
{
	/**
	 * Default Constructor, calls the splash screen constructor and a method 
	 * to compute our loading tasks, which in turn progress the Splash.
	 */
	public Main()
	{
		//Creates the splash screen in a new thread, so we can continue loading our program as usual.
		super();
	...
	/**
	 * This simulates the work our so called "Loader" would be doing, 
	 * this increments the splash screen. This would technically be replaced 
	 * by our loading tasks which would incremented the splash loader appropriately.
	 * This may be replaced all together by a new class which has a sole 
	 * purpose of initializing our program.
	 */
